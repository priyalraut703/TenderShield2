...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      submitEligibleBid: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`submitEligibleBid: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const vendorId_0 = args_1[1];
        const annualTurnover_0 = args_1[2];
        const opening_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submitEligibleBid',
                                     'argument 1 (as invoked from Typescript)',
                                     'tendershield.compact line 59 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        if (!(typeof(annualTurnover_0) === 'bigint' && annualTurnover_0 >= 0n && annualTurnover_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('submitEligibleBid',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(vendorId_0).concat(_descriptor_2.toValue(annualTurnover_0).concat(_descriptor_0.toValue(opening_0))),
        ...
        const result_0 = this._submitEligibleBid_0(context,
                                                   partialProofData,
                                                   vendorId_0,
                                                   annualTurnover_0,
                                                   opening_0);
      ...
      closeTender: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('closeTender',
                                     'argument 1 (as invoked from Typescript)',
                                     'tendershield.compact line 79 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._closeTender_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = {
      submitEligibleBid: this.circuits.submitEligibleBid,
  ...
  initialState(...args_0) {
    ...
    if (!(id_0.buffer instanceof ArrayBuffer && id_0.BYTES_PER_ELEMENT === 1 && id_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'tendershield.compact line 53 char 1',
                                 'Bytes<32>',
                                 id_0)
    }
    ...
    state_0.setOperation('submitEligibleBid', new __compactRuntime.ContractOperation());
                       ...
                       opening_0)
  {
    ...
    __compactRuntime.assert(annualTurnover_0
                            >=
    ...
    const tmp_0 = this._persistentCommit_0([vendorId_0,
                                            __compactRuntime.convertFieldToBytes(32,
                                                                                 annualTurnover_0,
                                                                                 'tendershield.compact line 73 char 16')],
                                           opening_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _closeTender_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
